...
int mag_affects(int level, struct char_data *ch, struct char_data *victim, int spellnum, int savetype)
{
...
int mag_protections(int level, struct char_data *ch, struct char_data *tch, int spellnum, int spellprot, int dur,
                    int res)
{
    struct str_spells *spell;
...
static int perform_mag_groups(int level, struct char_data *ch, struct char_data *tch, int spellnum, int savetype)
{
    int flags = 0;
...
int mag_points(int level, struct char_data *ch, struct char_data *victim, int spellnum, int savetype)
{
    struct str_spells *spell;
...
int mag_unaffects(int level, struct char_data *ch, struct char_data *victim, int spellnum, int type)
{
...
int mag_alter_objs(int level, struct char_data *ch, struct obj_data *obj, int spellnum, int savetype)
{
    int effect = 1;
    struct str_spells *spell;
