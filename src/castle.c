...
static int banzaii(struct char_data *ch)
{
  ...
  act("$n berra: 'Protejam o Reino do Grande Rei Welmar!  BANZAIIII!!!'",
...
static int do_npc_rescue(struct char_data *ch_hero, struct char_data *ch_victim)
{
  ...
  act("Você foi salv$r por $N, $X(seu,sua) leal amig$R!",
...
SPECIAL(training_master)
{
  ...
  case 5:
    ...
    act("$n investe um golpe contra você, mas você habilidosamente desvia dele.", FALSE, pupil1, 0, pupil2, TO_VICT);
    break;

  case 6:
    act("$n desajeitadamente tenta chutar $N, mas erra.", FALSE, pupil1, 0, pupil2, TO_NOTVICT);
    act("Você erra grosseiramente um chute contra $N, sem direito a desculpas.", FALSE, pupil1, 0, pupil2, TO_CHAR);
...
static int castle_cleaner(struct char_data *ch, int cmd, int gripe)
{
  ...
  for (i = world[IN_ROOM(ch)].contents; i; i = i->next_content) {
    ...
    if (gripe) {
      act("$n diz: 'Deus, Ó Deus!  Eu tenho de demitir esta faxineira preguiçosa!'",
          FALSE, ch, 0, 0, TO_ROOM);
...
SPECIAL(peter)
{
  ...
  if (!(rand_number(0, 3)) && (ch_guard = find_guard(ch)))
    ...
    case 0:
      act("$N recupera rapidamente sua atenção no momento em que $n inspeciona $L.",
	  FALSE, ch, 0, ch_guard, TO_NOTVICT);
      act("$N recupera rapidamente sua atenção no momento em que você inspeciona $L.",
	  FALSE, ch, 0, ch_guard, TO_CHAR);
      act("Você recupera rapidamente a atenção no momento em que $n inspeciona você.",
	  FALSE, ch, 0, ch_guard, TO_VICT);
      break;
    case 1:
      act("$N sente-se muito humilhad$R, no instante que $n berra com $L.",
	  FALSE, ch, 0, ch_guard, TO_NOTVICT);
      act("$N sente-se muito humilhad$R no instante que você berra com $L.",
	  FALSE, ch, 0, ch_guard, TO_CHAR);
      act("Você se sente muito humilhado no instante que $N berra com você.",
	  FALSE, ch, 0, ch_guard, TO_VICT);
      break;
    case 2:
      act("$n fornece para $N algumas ordens reais.",
	  FALSE, ch, 0, ch_guard, TO_NOTVICT);
      act("Você fornece para $N algumas ordens reais.",
	  FALSE, ch, 0, ch_guard, TO_CHAR);
      act("$n fornece a você algumas ordens reais.",
	  FALSE, ch, 0, ch_guard, TO_VICT);
      break;
    case 3:
      act("$n olha para você.", FALSE, ch, 0, ch_guard, TO_VICT);
      act("$n olha para $N.", FALSE, ch, 0, ch_guard, TO_NOTVICT);
      act("$n rosna: 'Estas botas precisam de polimento!'",
    ...
    case 4:
      act("$n olha para você.", FALSE, ch, 0, ch_guard, TO_VICT);
      act("$n olha para $N.", FALSE, ch, 0, ch_guard, TO_NOTVICT);
      act("$n rosna: 'Arrume seu colarinho!'",
	  FALSE, ch, 0, ch_guard, TO_ROOM);
      act("Você rosna com $N.", FALSE, ch, 0, ch_guard, TO_CHAR);
      break;
    default:
      act("$n olha para você.", FALSE, ch, 0, ch_guard, TO_VICT);
      act("$n olha para $N.", FALSE, ch, 0, ch_guard, TO_NOTVICT);
      act("$n rosna: 'Esta armadura de correntes parece enferrujada!  LIMPE-A !!!'",
	  FALSE, ch, 0, ch_guard, TO_ROOM);
      act("Você rosna com $N.", FALSE, ch, 0, ch_guard, TO_CHAR);
      break;
    }
...
SPECIAL(jerry)
{
  ...
  switch (rand_number(0, 5)) {
  case 0:
    act("$n joga os dados e, alegre, grita alto com o resultado.",
	    FALSE, gambler1, 0, gambler2, TO_NOTVICT);
    act("Você joga os dados e grita: GRANDE!",
	    FALSE, gambler1, 0, gambler2, TO_CHAR);
    act("$n grita alto enquanto $l joga os dados.",
	    FALSE, gambler1, 0, gambler2, TO_VICT);
    break;
  case 1:
    act("$n amaldiçoa a Deusa da Sorte veementemente quando $l vê a jogada de $N.",
	    FALSE, gambler1, 0, gambler2, TO_NOTVICT);
    act("Você amaldiçoa a Deusa da Sorte quando $N joga.",
	    FALSE, gambler1, 0, gambler2, TO_CHAR);
    act("$n pragueja irritadamente. Você está com sorte!",
	    FALSE, gambler1, 0, gambler2, TO_VICT);
    break;
  case 2:
    act("$n suspira alto e dá para $N um pouco de ouro.",
	    FALSE, gambler1, 0, gambler2, TO_NOTVICT);
    act("Você suspira alto pela dor de ter que dar para $N um pouco de ouro.",
	    FALSE, gambler1, 0, gambler2, TO_CHAR);
    act("$n suspira alto no instante em que $l lhe dá seu justo prêmio pela vitória.",
	    FALSE, gambler1, 0, gambler2, TO_VICT);
    break;
  case 3:
    act("$n sorri chei$r de remorso quando a jogada de $N supera a d$l.",
	    FALSE, gambler1, 0, gambler2, TO_NOTVICT);
    act("Você sorri tristemente quando você vê que $N vence você. Novamente.",
	    FALSE, gambler1, 0, gambler2, TO_CHAR);
    act("$n sorri chei$r de remorso quando sua jogada supera a d$l.",
	    FALSE, gambler1, 0, gambler2, TO_VICT);
    break;
  case 4:
    act("$n, excitad$r, segue a jogada com seus olhos.",
	    FALSE, gambler1, 0, gambler2, TO_NOTVICT);
    act("Você excitadamente segue a jogada com seus olhos.",
	    FALSE, gambler1, 0, gambler2, TO_CHAR);
    act("$n, excitad$r, segue a jogada com seus olhos.",
	    FALSE, gambler1, 0, gambler2, TO_VICT);
    break;
  default:
    act("$n diz 'Bem, minha sorte tem de mudar logo', no momento em que $l balança os dados.",
	    FALSE, gambler1, 0, gambler2, TO_NOTVICT);
    act("Você diz 'Bem, minha sorte tem de mudar logo' e balança os dados.",
	    FALSE, gambler1, 0, gambler2, TO_CHAR);
    act("$n diz 'Bem, minha sorte tem de mudar logo', no momento em que $l balança os dados.",
	    FALSE, gambler1, 0, gambler2, TO_VICT);
    break;
