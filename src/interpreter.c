...
cpp_extern const struct command_info cmd_info[] = {
	...
	{"north", "n", POS_STANDING, do_move, 0, SCMD_NORTH, CMD_NONE},
	{"east", "e", POS_STANDING, do_move, 0, SCMD_EAST, CMD_NONE},
	{"south", "s", POS_STANDING, do_move, 0, SCMD_SOUTH, CMD_NONE},
	{"west", "w", POS_STANDING, do_move, 0, SCMD_WEST, CMD_NONE},
	{"up", "u", POS_STANDING, do_move, 0, SCMD_UP, CMD_NONE},
	{"down", "d", POS_STANDING, do_move, 0, SCMD_DOWN, CMD_NONE},
	{"northwest", "northw", POS_STANDING, do_move, 0, SCMD_NW, CMD_NONE},
	{"nw", "nw", POS_STANDING, do_move, 0, SCMD_NW, CMD_NONE},
	{"northeast", "northe", POS_STANDING, do_move, 0, SCMD_NE, CMD_NONE},
	{"ne", "ne", POS_STANDING, do_move, 0, SCMD_NE, CMD_NONE},
	{"southeast", "southe", POS_STANDING, do_move, 0, SCMD_SE, CMD_NONE},
	{"se", "se", POS_STANDING, do_move, 0, SCMD_SE, CMD_NONE},
	{"southwest", "southw", POS_STANDING, do_move, 0, SCMD_SW, CMD_NONE},
	{"sw", "sw", POS_STANDING, do_move, 0, SCMD_SW, CMD_NONE},
...
void command_interpreter(struct char_data *ch, char *argument)
{
   ...
   /*pega dados pro aventureiro */
	...
	if (*complete_cmd_info[cmd].command == '\n')
	{
		...
		case POS_MORTALLYW:
			send_to_char(ch,
						 "Você está em uma condição muito ruim, impossível fazer qualquer coisa!\r\n");
			break;
		case POS_STUNNED:
		...
		if (!strcmp(GET_NAME(k->character), GET_NAME(d->character)))
		{
			...
			if ((STATE(k) > CON_PLAYING) && (STATE(k) < CON_QCLASS))
			{
				...
				mudlog(NRM, LVL_GOD, TRUE,
					   "Multiple logins detected in char creation for %s.",
