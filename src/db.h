...
#    define PAUSE_FILE "::pause"            /* autorun: don't restart mud	*/
#else
#    define EXE_FILE "lib/bin/circle"         /* maybe use argv[0] but it's not reliable */
#    define FASTBOOT_FILE "lib/.fastboot"     /* autorun: boot without sleep  */
#    define KILLSCRIPT_FILE "lib/.killscript" /* autorun: shut mud down       */
#    define PAUSE_FILE "lib/pause"            /* autorun: don't restart mud   */
#endif
...
#define MENU_FILE LIB_TEXT "menu"
...
#define CLANPOL_FILE LIB_TEXT "clan-policies" /* clan policies/rules	*/
#define REBEGIN_FILE LIB_TEXT "rebegin"       /* player policies/rules	*/
...
struct zone_data {
    ...
    int climate;                  /* zone climate				 */
    struct weather_data *weather; /* zone weather (if climate != default)	 */
};
...
extern room_rnum r_dead_start_room;
