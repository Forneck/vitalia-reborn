...
/* Visual indicator thresholds - menu items 77-96 */
...
#define CEDIT_EMOTION_DISPLAY_COMPASSION_THRESHOLD 83
#define CEDIT_EMOTION_DISPLAY_COURAGE_THRESHOLD 84
#define CEDIT_EMOTION_DISPLAY_CURIOSITY_THRESHOLD 85
#define CEDIT_EMOTION_DISPLAY_DISGUST_THRESHOLD 86
#define CEDIT_EMOTION_DISPLAY_ENVY_THRESHOLD 87
#define CEDIT_EMOTION_DISPLAY_EXCITEMENT_THRESHOLD 88
#define CEDIT_EMOTION_DISPLAY_FRIENDSHIP_THRESHOLD 89
#define CEDIT_EMOTION_DISPLAY_GREED_THRESHOLD 90
#define CEDIT_EMOTION_DISPLAY_HUMILIATION_THRESHOLD 91
#define CEDIT_EMOTION_DISPLAY_LOVE_THRESHOLD 92
#define CEDIT_EMOTION_DISPLAY_LOYALTY_THRESHOLD 93
#define CEDIT_EMOTION_DISPLAY_PRIDE_THRESHOLD 94
#define CEDIT_EMOTION_DISPLAY_SHAME_THRESHOLD 95
#define CEDIT_EMOTION_DISPLAY_TRUST_THRESHOLD 96
/* Combat flee behavior thresholds - menu items 97-101 */
#define CEDIT_EMOTION_FLEE_FEAR_LOW_THRESHOLD 97
#define CEDIT_EMOTION_FLEE_FEAR_HIGH_THRESHOLD 98
#define CEDIT_EMOTION_FLEE_COURAGE_LOW_THRESHOLD 99
#define CEDIT_EMOTION_FLEE_COURAGE_HIGH_THRESHOLD 100
#define CEDIT_EMOTION_FLEE_HORROR_THRESHOLD 101
/* Flee modifier values - menu items 102-106 */
#define CEDIT_EMOTION_FLEE_FEAR_LOW_MODIFIER 102
#define CEDIT_EMOTION_FLEE_FEAR_HIGH_MODIFIER 103
#define CEDIT_EMOTION_FLEE_COURAGE_LOW_MODIFIER 104
#define CEDIT_EMOTION_FLEE_COURAGE_HIGH_MODIFIER 105
#define CEDIT_EMOTION_FLEE_HORROR_MODIFIER 106
/* Pain system thresholds - menu items 107-110 */
#define CEDIT_EMOTION_PAIN_DAMAGE_MINOR_THRESHOLD 107
#define CEDIT_EMOTION_PAIN_DAMAGE_MODERATE_THRESHOLD 108
#define CEDIT_EMOTION_PAIN_DAMAGE_HEAVY_THRESHOLD 109
#define CEDIT_EMOTION_PAIN_DAMAGE_MASSIVE_THRESHOLD 110
/* Pain values - menu items 111-118 */
#define CEDIT_EMOTION_PAIN_MINOR_MIN 111
#define CEDIT_EMOTION_PAIN_MINOR_MAX 112
#define CEDIT_EMOTION_PAIN_MODERATE_MIN 113
#define CEDIT_EMOTION_PAIN_MODERATE_MAX 114
#define CEDIT_EMOTION_PAIN_HEAVY_MIN 115
#define CEDIT_EMOTION_PAIN_HEAVY_MAX 116
#define CEDIT_EMOTION_PAIN_MASSIVE_MIN 117
#define CEDIT_EMOTION_PAIN_MASSIVE_MAX 118
/* Memory system weights - menu items 119-123 */
#define CEDIT_EMOTION_MEMORY_WEIGHT_RECENT 119
#define CEDIT_EMOTION_MEMORY_WEIGHT_FRESH 120
#define CEDIT_EMOTION_MEMORY_WEIGHT_MODERATE 121
#define CEDIT_EMOTION_MEMORY_WEIGHT_OLD 122
#define CEDIT_EMOTION_MEMORY_WEIGHT_ANCIENT 123
/* Memory age thresholds - menu items 124-127 */
#define CEDIT_EMOTION_MEMORY_AGE_RECENT 124
#define CEDIT_EMOTION_MEMORY_AGE_FRESH 125
#define CEDIT_EMOTION_MEMORY_AGE_MODERATE 126
#define CEDIT_EMOTION_MEMORY_AGE_OLD 127
/* Memory baseline offset - menu item 128 */
#define CEDIT_EMOTION_MEMORY_BASELINE_OFFSET 128

/* Emotion submenu modes */
#define CEDIT_EMOTION_DISPLAY_SUBMENU 129
#define CEDIT_EMOTION_FLEE_SUBMENU 130
#define CEDIT_EMOTION_PAIN_SUBMENU 131
#define CEDIT_EMOTION_MEMORY_SUBMENU 132
#define CEDIT_EMOTION_PRESET_MENU 133
/* Weather emotion configuration */
#define CEDIT_WEATHER_EFFECT_MULTIPLIER 134
/* Death trap warehouse configuration */
#define CEDIT_DT_WAREHOUSE_ROOM 135
/* Max mob-posted quests configuration */
#define CEDIT_MAX_MOB_POSTED_QUESTS 136
/* Group behavior emotion configuration */
#define CEDIT_EMOTION_GROUP_LOYALTY_HIGH_THRESHOLD 137
#define CEDIT_EMOTION_GROUP_LOYALTY_LOW_THRESHOLD 138
#define CEDIT_EMOTION_GROUP_FRIENDSHIP_HIGH_THRESHOLD 139
#define CEDIT_EMOTION_GROUP_ENVY_HIGH_THRESHOLD 140
#define CEDIT_EMOTION_GROUP_SUBMENU 141
/* Combat behavior emotion configuration */
#define CEDIT_EMOTION_COMBAT_SUBMENU 142
#define CEDIT_EMOTION_COMBAT_ANGER_HIGH_THRESHOLD 143
#define CEDIT_EMOTION_COMBAT_ANGER_DAMAGE_BONUS 144
#define CEDIT_EMOTION_COMBAT_ANGER_ATTACK_BONUS 145
#define CEDIT_EMOTION_COMBAT_PAIN_LOW_THRESHOLD 146
#define CEDIT_EMOTION_COMBAT_PAIN_MODERATE_THRESHOLD 147
#define CEDIT_EMOTION_COMBAT_PAIN_HIGH_THRESHOLD 148
#define CEDIT_EMOTION_COMBAT_PAIN_ACCURACY_PENALTY_LOW 149
#define CEDIT_EMOTION_COMBAT_PAIN_ACCURACY_PENALTY_MOD 150
#define CEDIT_EMOTION_COMBAT_PAIN_ACCURACY_PENALTY_HIGH 151
#define CEDIT_EMOTION_COMBAT_PAIN_DAMAGE_PENALTY_LOW 152
#define CEDIT_EMOTION_COMBAT_PAIN_DAMAGE_PENALTY_MOD 153
#define CEDIT_EMOTION_COMBAT_PAIN_DAMAGE_PENALTY_HIGH 154

/* Emotion Decay Rate Configuration */
#define CEDIT_EMOTION_DECAY_SUBMENU 155
#define CEDIT_EMOTION_DECAY_RATE_MULTIPLIER 156
#define CEDIT_EMOTION_EXTREME_EMOTION_THRESHOLD 157
#define CEDIT_EMOTION_EXTREME_DECAY_MULTIPLIER 158
#define CEDIT_EMOTION_DECAY_RATE_FEAR 159
#define CEDIT_EMOTION_DECAY_RATE_ANGER 160
#define CEDIT_EMOTION_DECAY_RATE_HAPPINESS 161
#define CEDIT_EMOTION_DECAY_RATE_SADNESS 162
#define CEDIT_EMOTION_DECAY_RATE_PAIN 163
#define CEDIT_EMOTION_DECAY_RATE_HORROR 164
...
#define CEDIT_NEUROTICISM_GAIN_FEAR 169
#define CEDIT_NEUROTICISM_GAIN_SADNESS 170
#define CEDIT_NEUROTICISM_GAIN_SHAME 171
#define CEDIT_NEUROTICISM_GAIN_HUMILIATION 172
#define CEDIT_NEUROTICISM_GAIN_PAIN 173
#define CEDIT_NEUROTICISM_GAIN_HORROR 174
#define CEDIT_NEUROTICISM_GAIN_DISGUST 175
#define CEDIT_NEUROTICISM_GAIN_ENVY 176
#define CEDIT_NEUROTICISM_GAIN_ANGER 177
#define CEDIT_NEUROTICISM_SOFT_CLAMP_K 178

/* Big Five Phase 2: Conscientiousness configuration */
#define CEDIT_BIGFIVE_CONSCIENTIOUSNESS_SUBMENU 179
#define CEDIT_CONSCIENTIOUSNESS_IMPULSE_CONTROL 180
...
/* Social gossip configuration */
#define CEDIT_MOB_GOSSIP_CHANCE 219
#define CEDIT_MOB_GOSSIP_COOLDOWN 220
